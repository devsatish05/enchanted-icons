...
const content: IIconContent[] = [
  ...
  },
  {
    elem: 'path',
    attrs: {
      d: 'M8.25 12C9.07843 12 9.75 12.6716 9.75 13.5V15.75C9.75 16.5784 9.07843 17.25 8.25 17.25H6C5.17157 17.25 4.5 16.5784 4.5 15.75V13.5C4.5 12.6716 5.17157 12 6 12H8.25ZM8.25 13.5H6V15.75H8.25V13.5Z',
      fill: 'currentColor',
      stroke: 'none',
      strokeLinejoin: 'round',
      strokeMiterlimit: 10,
...
export default createSvgIcon(
  'page--elements--content-container',
  24,
  content,
  attrs,
