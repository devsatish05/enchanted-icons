...
const content: IIconContent[] = [
  ...
  },
  {
    elem: 'path',
    attrs: {
      d: 'M21 12C21.8284 12 22.5 12.6716 22.5 13.5V21C22.5 21.8284 21.8284 22.5 21 22.5H13.5C12.6716 22.5 12 21.8284 12 21V13.5C12 12.6716 12.6716 12 13.5 12H21ZM21 19.5H13.5V21H21V19.5ZM13.5 16.5V18H21V16.5H13.5ZM13.5 15H21V13.5H13.5V15Z',
      fill: 'currentColor',
      stroke: 'none',
      strokeLinejoin: 'round',
      strokeMiterlimit: 10,
...
export default createSvgIcon(
  'page--elements--content-list-item',
  24,
  content,
  attrs,
