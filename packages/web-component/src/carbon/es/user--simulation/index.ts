...
export class WebComponentIcon extends BaseIcon {
  render() {
     ...
     */
    return html`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" width="32" height="32" preserveAspectRatio="xMidYMid"><path d="M25.232 12.866H29.232V14.866H25.232z" transform="rotate(30 27.232 13.866)" /><path d="M26 8H30V10H26z" /><path d="M2.768 12.866H6.768V14.866H2.768z" transform="rotate(150 4.768 13.866)" /><path d="M26,30H24V25a5.0059,5.0059,0,0,0-5-5H13a5.0059,5.0059,0,0,0-5,5v5H6V25a7.0082,7.0082,0,0,1,7-7h6a7.0082,7.0082,0,0,1,7,7Z" /><path d="M16,4a5,5,0,1,1-5,5,5,5,0,0,1,5-5m0-2a7,7,0,1,0,7,7A7,7,0,0,0,16,2Z" /><path d="M25.232 3.134H29.232V5.134H25.232z" transform="rotate(-30 27.232 4.134)" /><path d="M2 8H6V10H2z" /><path d="M2.768 3.134H6.768V5.134H2.768z" transform="rotate(210 4.768 4.134)" /></svg>`;
  }
}
